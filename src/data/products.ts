...
export const PRODUCTS: Product[] = [
  ...
  // ==========================================
  {
    ...
    category: 'pickles',
    traditionalPreparation: 'Sun-cured in traditional ceramic Bharani porcelain with Groundnut Oil, stone-ground mustard & Normal Salt.',
    ...
    storageInstructions: 'Keep in ceramic or glass jar with a dry wooden or steel spoon. Keep Groundnut Oil floating slightly over the pickle.',
  ...
  },
  {
    ...
    description: 'Rare and authentic culinary art. Firm, fibrous young raw jackfruit (panasa) cut into bite-sized pieces, steam-cured, and steeped in aromatic Groundnut Oil and red chilli spices. Provides a hearty, textured, meaty bite while remaining 100% pure sattvic vegetarian.',
  ...
  },
  {
    ...
    traditionalPreparation: 'Made of hand-roasted peanuts in small batches and freshly ground.',
    description: 'Made of hand-roasted peanuts in small batches and freshly ground.',
    image: '/images/ekadasi_palli_podi.jpg',
    ingredients: ['Hand-Roasted Peanuts (Palli)', 'Normal Salt', 'Cumin Seeds', 'Sun-Dried Red Chillies'],
  ...
  },
  {
    ...
    category: 'powders',
    subCategory: 'Ekadasi Vrata Special',
    traditionalPreparation: 'Consecrated blend of fasting-approved sweet spices ground with Normal Salt strictly without forbidden seeds or grains.',
    description: 'Created exclusively for devotees observing Ekadasi and Chaturmasya vows. Made only with permissible sattvic whole spices (cardamom, clove, cinnamon, black pepper, cumin) and Normal Salt. Perfect for seasoning deity naivedyam.',
    image: '/images/ekadasi_garam_masala.jpg',
    ingredients: ['Normal Salt', 'Green Cardamom', 'Cloves', 'Cinnamon', 'Black Pepper', 'Cumin Seeds', 'Nutmeg'],
